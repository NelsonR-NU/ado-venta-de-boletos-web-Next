      ...
      <Container className="h-full flex items-center !py-0 ">
        <div className=" w-full h-full flex items-center justify-between " ref={dropdownRef}>
          <div className=" flex items-center justify-center gap-[4px] ">
            <Image src={AtencionIcon} alt="ADO Logo" className="w-[16px] mt-1 " />
            <a href="#" className=" text-[12px] cursor-pointer text-[#FAFAFA] ">
              Atención a clientes HOLA
            </a>
          </div>
          <div className=" flex items-center justify-center gap-[32px] ">
            <div className=" flex items-center justify-center gap-[4px] ">
              <Image src={TamanoIcon} alt="Tamano Icon" className="w-[16px] " />
              <a href="#" className=" text-[12px] cursor-pointer text-[#FAFAFA] ">
                Tamaño
              </a>
            </div>
            <div
              className="relative flex items-center gap-[4px] cursor-pointer"
