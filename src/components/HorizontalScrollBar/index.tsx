...
const DateSlider: React.FC<DateSliderProps> = ({ onDateSelect }) => {
  ...
  return (
    <div className="flex items-center justify-center  p-4 rounded-lg w-full max-w-[100vw] sm:max-w-[600px] md:max-w-[800px] lg:max-w-[1200px] mx-auto max-[500px]:p-0 max-[500px]:m-0">
      {showArrows && (
