  ...
  return (
    <div className="flex flex-col gap-6 p-4 md:w-[100%] w-full">
      {!isAuthenticated ? (
        ...
        <div className="text-ado-text-gray text-lg font-bold px-2">
          <span>{t("ticket_sent_to")}</span>
          <a
            href="mailto:jimena.vinat@gmail.com"
            className="text-ado-teal font-bold hover:underline mx-2">
      ...
      <Card className="bg-ado-ice-blue">
        <div className="flex flex-wrap mb-3 gap-2 sm:gap-4 text-sm text-black border-b border-ado-frost-gray pb-4">
          <span>
            {t("passenger")} 1: <strong>{t("adult")}</strong>
          </span>
          <span>
            {t("seat_departure")} <strong>17</strong>
          </span>
          <span>
            {t("seat_return")} <strong>16</strong>
          </span>
        </div>
        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-center mt-4 border-t pt-4 gap-3 sm:gap-6">
          ...
          <div className="flex flex-col sm:flex-row gap-3 sm:gap-6">
            <Checkbox
              label={
                <span className="text-sm text-ado-charcoal">{`${t("departure")} $15.00 MXN`}</span>
              }
              name="assistanceIda"
            ...
            <Checkbox
              label={
                <span className="text-sm text-ado-charcoal">{`${t("return")} $15.00 MXN`}</span>
              }
