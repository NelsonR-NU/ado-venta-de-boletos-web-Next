...
interface TripPlaceProps { title: string, content: string, className?: string }
...
const TicketDetailsDrawer: React.FC<TicketDetailsDrawer> = ({ isOpen, onClose }: TicketDetailsDrawer) => {
                ...
                <div className="bg-ado-bg-light-gray text-base text-ado-text-gray p-6 flex flex-col gap-4">
                    ...
                    <div className="flex flex-col gap-3">
                        <div className="flex justify-between">
                            <div className="flex flex-col gap-3">
                                <TripPlace title={t("origen")} content="Central México Norte, CDMX" className={"text-xs"} />
                                <TripPlace title={t("destination")} content="Acapulco Costera, Gro." className={"text-xs"} />
                            </div>
                    ...
                    <div className="flex flex-col gap-4 bg-ado-white px-6 py-4 rounded-lg ">
                        <h2 className="px-2 py-4 text-sm text-ado-text-gray font-bold border-b border-ado-light-blue-gray">Detalles del viaje</h2>
                        <div className="flex flex-col">
                                ...
                                <div className="w-10 flex flex-col justify-end items-center">
                                    ...
                                    <div className="flex flex-col w-fit p-[3px] items-center gap-1 bg-ado-gray ">
                                        {Array.from({ length: 8 }).map((_, index) => (
                                            <span
                                                key={index}
                                                className="w-[5px] h-[5px] rounded-full bg-[#9999B3]"
                                            ></span>
                                        ))}
                                    </div>
                                </div>
                                <div className="flex-1 ">
                                    <div className="flex justify-between items-center gap-4 border-b border-ado-gray pl-2 py-3">
                                        <div className="flex flex-col gap-1">
                                            ...
                                            <p className="text-xs">Tiempo libre en la sala de espera de Autobuses para abordar.</p>
                                        </div>
                            ...
                            <div className="flex">
                                ...
                                <div className="flex-1 flex flex-col  gap-2">
                                    ...
                                    <div onClick={() => setShowStops((show) => !show)} className="flex border-b border-ado-gray pl-2 py-3 cursor-pointer">
                                        <div className="flex items-center gap-2 ">
                                            <Image src={showStops ? upArrow : downArrow} alt="up arrow icon " className="w-2 h-2" />
                                            <h3 className="text-sm">4 paradas</h3>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            {showStops && stops.map(item => (
                                <div className="flex">
