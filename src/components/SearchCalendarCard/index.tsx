                ...
                <div className='absolute right-[-90] top-full bg-[#FAFAFA] mt-2 p-[24px] w-[700px] flex flex-col rounded-[8px] ' >
                    ...
                    <div className=' w-full flex items-center justify-between mt-4 ' >
                        <div className=' flex items-center ' >
                            <div className=' w-[18px] h-[18px] rounded-[4px] cursor-pointer flex justify-center items-center '
                                style={{ backgroundColor: `${selected ? '#5F2167' : '#FAFAFA'}`, border: `${!selected && '1px solid #808391'}` }}
